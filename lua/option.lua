...
cmd.anoremenu("PopUp.Go\\ to\\ definition", "<Cmd>lua vim.lsp.buf.definition()<CR>")
cmd.amenu("PopUp.Open\\ in\\ web\\ browser", "gx")
cmd.anoremenu("PopUp.Inspect", "<Cmd>Inspect<CR>")
...
cmd.vnoremenu("PopUp.Quit", "<Cmd>q<CR>")

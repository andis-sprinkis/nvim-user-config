...
Plug 'andis-sprinkis/indent-blankline.nvim'
...
Plug 'andis-sprinkis/commented.nvim'
...
if vim.g.plug_requirement.markdown_preview then vim.cmd([[Plug 'andis-sprinkis/markdown-preview.nvim', { 'do': 'cd app && yarn install'  }]]) end
